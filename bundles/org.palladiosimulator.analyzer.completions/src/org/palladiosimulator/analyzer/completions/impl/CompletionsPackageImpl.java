...
public class CompletionsPackageImpl extends EPackageImpl implements CompletionsPackage {
	 ...
	 * @see org.palladiosimulator.analyzer.completions.CompletionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CompletionsPackage init() {
		...
		Object registeredCompletionsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CompletionsPackageImpl theCompletionsPackage = registeredCompletionsPackage instanceof CompletionsPackageImpl
				? (CompletionsPackageImpl) registeredCompletionsPackage
	...
	public void createPackageContents() {
		...
		createEReference(networkDemandParametricResourceDemandEClass,
	...
	public void initializePackageContents() {
		...
		networkDemandParametricResourceDemandEClass.getESuperTypes()
		...
		initEClass(completionRepositoryEClass, CompletionRepository.class, "CompletionRepository", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompletionRepository_Completions_CompletionRepository(), this.getCompletion(), null,
				"completions_CompletionRepository", null, 0, -1, CompletionRepository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(delegatingExternalCallActionEClass, DelegatingExternalCallAction.class,
				"DelegatingExternalCallAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(networkDemandParametricResourceDemandEClass, NetworkDemandParametricResourceDemand.class,
