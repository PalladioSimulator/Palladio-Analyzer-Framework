...
public class CompletionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CompletionsPackage.COMPLETION: {
			...
			if (result == null)
				result = caseComposedProvidingRequiringEntity(completion);
			if (result == null)
				result = caseImplementationComponentType(completion);
			if (result == null)
				result = caseComposedStructure(completion);
			if (result == null)
				result = caseRepositoryComponent(completion);
			if (result == null)
				result = caseInterfaceProvidingRequiringEntity(completion);
			if (result == null)
				result = caseInterfaceProvidingEntity(completion);
			if (result == null)
				result = caseInterfaceRequiringEntity(completion);
			if (result == null)
				result = caseIdentifier(completion);
			if (result == null)
				result = caseNamedElement(completion);
			if (result == null)
				result = caseResourceInterfaceRequiringEntity(completion);
			if (result == null)
				result = caseEntity(completion);
			if (result == null)
		...
		case CompletionsPackage.DELEGATING_EXTERNAL_CALL_ACTION: {
			...
			if (result == null)
				result = caseExternalCallAction(delegatingExternalCallAction);
			if (result == null)
				result = caseAbstractAction(delegatingExternalCallAction);
			if (result == null)
				result = caseCallReturnAction(delegatingExternalCallAction);
			if (result == null)
				result = caseFailureHandlingEntity(delegatingExternalCallAction);
			if (result == null)
				result = caseCallAction(delegatingExternalCallAction);
			if (result == null)
				result = caseEntity(delegatingExternalCallAction);
			if (result == null)
				result = caseIdentifier(delegatingExternalCallAction);
			if (result == null)
				result = caseNamedElement(delegatingExternalCallAction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CompletionsPackage.NETWORK_DEMAND_PARAMETRIC_RESOURCE_DEMAND: {
			...
			if (result == null)
				result = caseParametricResourceDemand(networkDemandParametricResourceDemand);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
