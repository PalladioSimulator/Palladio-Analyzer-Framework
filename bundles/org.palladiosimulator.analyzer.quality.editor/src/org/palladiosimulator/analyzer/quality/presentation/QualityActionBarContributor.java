...
/**
 * This is the action bar contributor for the Quality model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class QualityActionBarContributor extends EditingDomainActionBarContributor
implements ISelectionChangedListener {
            ...
            QualityEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                QualityActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            QualityEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return QualityActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QualityActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QualityActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public QualityActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("quality-settings"));
        toolBarManager.add(new Separator("quality-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QualityEditorPlugin.INSTANCE.getString("_UI_QualityEditor_menu"),
                "org.palladiosimulator.analyzer.qualityMenuID");
