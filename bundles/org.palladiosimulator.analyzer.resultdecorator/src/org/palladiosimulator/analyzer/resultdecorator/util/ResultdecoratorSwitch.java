...
public class ResultdecoratorSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case ResultdecoratorPackage.RESULT_DECORATOR_REPOSITORY: {
            final ResultDecoratorRepository resultDecoratorRepository = (ResultDecoratorRepository) theEObject;
            T result = this.caseResultDecoratorRepository(resultDecoratorRepository);
            if (result == null) {
                result = this.caseNamedElement(resultDecoratorRepository);
            }
            if (result == null) {
     ...
     * <em>Result Decorator Repository</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Result Decorator Repository</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseResultDecoratorRepository(final ResultDecoratorRepository object) {
        return null;
    }
