...
public abstract class AbstractCodeGenerationWorkflowRunConfiguration extends AbstractPCMWorkflowRunConfiguration
    ...
    public AbstractCodeGenerationWorkflowRunConfiguration() {
        super();
        codeGenerationAdvices = new ArrayList<>();
        codeGenerationRequiredBundles = new ArrayList<>();
    }
    ...
    public String getStoragePluginID() {
        return sensitivityAnalysisEnabled ? super.getStoragePluginID() + getSensitivityAnalysisIdentifier()
                : super.getStoragePluginID();
    }
