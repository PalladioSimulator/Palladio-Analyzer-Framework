...
public class CompletionsItemProviderAdapterFactory extends CompletionsAdapterFactory
    ...
    public Adapter createCompletionAdapter() {
        if (this.completionItemProvider == null) {
            this.completionItemProvider = new CompletionItemProvider(this);
        }
    ...
    public Adapter createCompletionRepositoryAdapter() {
        if (this.completionRepositoryItemProvider == null) {
            this.completionRepositoryItemProvider = new CompletionRepositoryItemProvider(this);
        }

        return this.completionRepositoryItemProvider;
    }
    ...
    public Adapter createDelegatingExternalCallActionAdapter() {
        if (this.delegatingExternalCallActionItemProvider == null) {
            this.delegatingExternalCallActionItemProvider = new DelegatingExternalCallActionItemProvider(this);
        }

        return this.delegatingExternalCallActionItemProvider;
    }
    ...
    public Adapter createNetworkDemandParametricResourceDemandAdapter() {
        if (this.networkDemandParametricResourceDemandItemProvider == null) {
            this.networkDemandParametricResourceDemandItemProvider = new NetworkDemandParametricResourceDemandItemProvider(
                    this);
        }

        return this.networkDemandParametricResourceDemandItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (this.completionRepositoryItemProvider != null) {
            this.completionRepositoryItemProvider.dispose();
        }
        if (this.delegatingExternalCallActionItemProvider != null) {
            this.delegatingExternalCallActionItemProvider.dispose();
        }
        if (this.networkDemandParametricResourceDemandItemProvider != null) {
            this.networkDemandParametricResourceDemandItemProvider.dispose();
        }
    }
