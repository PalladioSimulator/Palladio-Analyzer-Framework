...
/**
 * This is the action bar contributor for the QualityAnnotation model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class QualityAnnotationActionBarContributor extends EditingDomainActionBarContributor
implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            QualityEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
            try
            {
                QualityAnnotationActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
    ...
    protected IAction refreshViewerAction = new Action(
            QualityEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        @Override
        public boolean isEnabled()
        {
            return QualityAnnotationActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QualityAnnotationActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QualityAnnotationActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
     ...
     * @generated
     */
    public QualityAnnotationActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("qualityannotation-settings"));
        toolBarManager.add(new Separator("qualityannotation-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QualityEditorPlugin.INSTANCE.getString("_UI_QualityAnnotationEditor_menu"),
                "org.palladiosimulator.analyzer.quality.qualityannotationMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                QualityEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                QualityEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(QualityEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(QualityEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
