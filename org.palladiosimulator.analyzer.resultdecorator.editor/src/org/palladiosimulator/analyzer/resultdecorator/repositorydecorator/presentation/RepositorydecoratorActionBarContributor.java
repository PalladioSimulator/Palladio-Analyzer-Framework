...
/**
 * This is the action bar contributor for the Repositorydecorator model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RepositorydecoratorActionBarContributor extends EditingDomainActionBarContributor
implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
            try
            {
                RepositorydecoratorActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return RepositorydecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (RepositorydecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) RepositorydecoratorActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
     ...
     * @generated
     */
    public RepositorydecoratorActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("repositorydecorator-settings"));
        toolBarManager.add(new Separator("repositorydecorator-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_RepositorydecoratorEditor_menu"),
                "org.palladiosimulator.analyzer.resultdecorator.repositorydecoratorMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
