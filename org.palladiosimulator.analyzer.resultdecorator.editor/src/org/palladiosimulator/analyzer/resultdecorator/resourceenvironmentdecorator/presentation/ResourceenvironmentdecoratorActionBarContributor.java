...
implements ISelectionChangedListener {
            ...
            ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                ResourceenvironmentdecoratorActionBarContributor.this.getPage().showView(
            ...
            ResultdecoratorEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return ResourceenvironmentdecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (ResourceenvironmentdecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) ResourceenvironmentdecoratorActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
     ...
     * @generated
     */
    public ResourceenvironmentdecoratorActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("resourceenvironmentdecorator-settings"));
        toolBarManager.add(new Separator("resourceenvironmentdecorator-additions"));
    }
