...
public class CompletionRepositoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures
                    .add(CompletionsPackage.Literals.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CompletionRepository"));
    }
    ...
    public String getText(final Object object) {
        return this.getString("_UI_CompletionRepository_type");
    }
    ...
    public void notifyChanged(final Notification notification) {
        ...
        switch (notification.getFeatureID(CompletionRepository.class)) {
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(
                CompletionsPackage.Literals.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY,
                CompletionsFactory.eINSTANCE.createCompletion()));
    }
